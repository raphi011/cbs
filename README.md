...
How far back "whole history" reaches is decided by the product terms. While terms were mutable columns, the window had to start at the last repricing: reaching further would have re-derived old days at *today's* rate. That bound was an accident of the storage, and it had a cost the customer could not see — a back-value landing before the last repricing was **never trued up at all**.
