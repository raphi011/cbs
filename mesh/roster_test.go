...
func TestStartGivesAFoundedBankNoActor(t *testing.T) {
	...
	if _, err := nordhaven.FoundBank(ctx, "Nordhaven Bank", "NORDSESSXXX", storetest.FixtureIssuer("NORDSESSXXX"), euroOnly); err != nil {
	...
	if _, err := m.Admit(ctx, "Nordhaven Bank", "NORDSESSXXX", storetest.FixtureIssuer("NORDSESSXXX"), euroOnly); err != nil {
