...
// still be blocked while the handler is. That direction is reliable rather than
// hopeful — a Stop that did not wait would return in microseconds, not in the
// 50 milliseconds this allows it.
